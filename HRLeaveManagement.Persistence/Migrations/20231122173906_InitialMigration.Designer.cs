...
namespace HRLeaveManagement.Persistence.Migrations
{
    ...
    [Migration("20231122173906_InitialMigration")]
            ...
            modelBuilder.Entity("HRLeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 11, 22, 14, 39, 5, 949, DateTimeKind.Local).AddTicks(596),
                            DateModified = new DateTime(2023, 11, 22, 14, 39, 5, 949, DateTimeKind.Local).AddTicks(609),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
